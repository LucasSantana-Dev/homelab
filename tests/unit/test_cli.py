...
class TestHomelabCLI:
    ...
    def test_init(self):
        ...
        with patch("homelab_manager.cli.HomelabAutomation"), \
    ...
    def test_deploy(self):
        """Test deploy command"""
        with patch("homelab_manager.cli.HomelabAutomation") as mock_automation, \
             patch("homelab_manager.cli.HomelabHealthMonitor"), \
             patch("homelab_manager.cli.HomelabUpdateManager"), \
             patch("homelab_manager.cli.HomelabConfig"):
    ...
    def test_main_function(self):
        ...
        with patch('sys.argv', ['cli.py', 'deploy']), patch('subprocess.run') as mock_run:
