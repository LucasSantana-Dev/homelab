...
EXCLUDE_PATH_REGEX='^(tests/|\.serena/|\.cursor/|security-reports/|appdata/|docs/access-layers\.md|scripts/security/public-safety-gate\.sh$|config/caddy/|config/cloudflared/|config/homepage/|config/alertmanager/|compose/media\.yml$)'
